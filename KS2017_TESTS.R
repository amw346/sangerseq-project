...
sink("C:/Users/amw346/Desktop/compareHapOutputKansasPART2.txt")
...
#relaxed criteria run <2 for insertion, deletion and mistmatch
sink("C:/Users/amw346/Desktop/compareHapOuputRelaexedCriteriaredoredo.txt")
compareHap(ks4f, newCombinedNoGapAllAdded)
compareHap(ks6f, newCombinedNoGapAllAdded)
compareHap(ks7f, newCombinedNoGapAllAdded)
compareHap(ks12f, newCombinedNoGapAllAdded)
...
#was invalid string error in previous ones so rerunin
#relaxed criteria run <2 for insertion, deletion and mistmatch
sink("C:/Users/amw346/Desktop/compareHapOuputRelaexedCriteriaredoredo2.txt")
compareHap(ks4f, newCombinedNoGapAllAdded)
compareHap(ks6f, newCombinedNoGapAllAdded)
compareHap(ks7f, newCombinedNoGapAllAdded)
compareHap(ks12f, newCombinedNoGapAllAdded)
